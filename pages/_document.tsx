  ...
  return (
    <Html lang="en">
      <Head>
        ...
        />
        {/* Hotjar Tracking Code for Site 5266391 */}
        <Script
          id="hotjar-script-5266391"
          strategy="beforeInteractive"
          dangerouslySetInnerHTML={{
            __html: `
              (function(h,o,t,j,a,r){
                  h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
                  h._hjSettings={hjid:5266391,hjsv:6};
        ...
        />
        {/* Hotjar Tracking Code for Site 5243173 */}
        <Script
          id="hotjar-script-5243173"
          strategy="beforeInteractive"
          dangerouslySetInnerHTML={{
            __html: `
